...
\SRQ{should have}{If there are no access rights to store the exported/saved data at the selected location, the application returns a \emph{no access rights} message.}
%Use case alternative S.1

\SRQ{should have}{If there is no memory space to store exported/saved data, the application returns an \emph{out of memory} message.}
