...
In some of the requirements in this section, the term ``fast enough" is mentioned: for a precise definition, refer to chapter 6 of the ADD \cite{add}.\\\\
...
\SRQ[SSC-2]{must have}{The Simulator Service Communication must be fast enough to serve the data from the Application Persistence to the Client Browser.}
