...
\SRQ[CB-11]{must have}[shapedraw]{The mixing interface contains a button that displays the current shape of the drawing tool.} % CPR7
...
\SRQ[CP-24]{should have}{The popup opened by \srqref{nomemoryexport} can be closed with an \texttt{ok} button}
%CPR33&35&37&39
\SRQ[CP-25]{should have}{The user can overwrite the old file in \srqref{nameinuse} with an \texttt{overwrite} button if a saved file already exists.}
%CPR33&35&37&39, Use case alternative S.3.1
\SRQ[CP-26]{should have}{The user can cancel overwriting the old file in \srqref{nameinuseexport} with a \texttt{cancel} button if a saved file already exists.}
%CPR33&35&37&39, Use case alternative S.3.1
...
\SRQ[CP-27]{should have}{The \texttt{load results} button can be used to open the load menu for a texttt{results} file.}
%CPR30&36
...
%CPR30&36
\SRQ[CP-28]{should have}{If in \srqref{displayload} multiple files are selected, all performance data is loaded in one graph.}
%CPR36
...
%CPR30&36
\SRQ[CP-31]{should have}{If multiple files are selected in the loading menu, they are all depicted in a single performance graph.}
%CPR36
...
%CPR32
\SRQ[SSC-4]{must have}{The user can use the \texttt{show performance} button to get visual information of the performance of the mixing run.}
%CPR34
...
\SRQ[NONF-1]{must have}{Waiting time between submitting input and receiving output is no longer than 5 seconds.}
%CNR10

\SRQ[NONF-2]{should have}{Waiting time between submitting input and receiving output is no longer than 3 seconds.}
%CNR11

\SRQ[NONF-3]{could have}{Waiting time between submitting input and receiving output is no longer than 1 seconds.}
%CNR12
