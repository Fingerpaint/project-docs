...
\label{sec:cellBrows}
  ...
  The Cell Browser is the first menu encountered by the user. Using the first menu level of the Cell Browser, the user can select the desired geometry for mixing. Currently, available geometries are the \emph{Rectangle} and the \emph{Square}. When one of the possible choices has been selected, the second menu level of the Cell Browser appears. This allows the user to select the desired mixer for the selected geometry. Currently, only the \emph{Default} mixers are available for both the \emph{Rectangle} and the \emph{Square} geometries.
...
\section{Distributions Menu}\label{sec:distmenu}
  ...
  The \emph{Remove} button creates a pop-up panel containing the names of all saved distributions. Next to each of these names is a delete button that can be used to delete the distribution. Deleting a distribution cannot be undone. 
  ...
  \begin{tabularx}{\textwidth}{XXX}
    ...
    \emph{Operation} & \emph{Steps} & \emph{Results} \\
    \midrule
    Save a distribution & Press the \emph{Save} button. & The \emph{Save Item Panel} appears. \\
    \midrule
    Load a distribution & Press the \emph{Load} button. & The \emph{Load Item Panel} appears. \\
    \midrule
    Remove a distribution & Press the \emph{Remove} button. & The \emph{Remove Item Panel} appears. \\
    \midrule
...
\section{Results Menu}\label{sec:resultsmenu}
  ...
  The \emph{Remove} button creates a pop-up panel containing the names of all saved results. Next to each of these names is a delete button that can be used to delete the result. Deleting a result cannot be undone. 
  
  The \emph{Compare Performance} button can be used to compare the performance of multiple runs. Pressing this button causes a pop-up panel to appear, in which the user can select results. The performance of all selected results are plotted in a graph once the user presses the \emph{Compare} button.
  ...
  \begin{tabularx}{\textwidth}{XXX}
    ...
    \emph{Operation} & \emph{Steps} & \emph{Results} \\
    \midrule
    Save a result & Press the \emph{Save} button. & The \emph{Save Item Panel} appears. \\
    \midrule
    Load a result & Press the \emph{Load} button. & The \emph{Load Item Panel} appears. \\
    \midrule
    Remove a result & Press the \emph{Remove} button. & The \emph{Remove Item Panel} appears. \\
    \midrule
    Compare the performance of multiple runs & Press the \emph{Compare Performance} button. & The \emph{Compare Multiple Graphs Panel} appears. \\
    \midrule
    Close this menu & Press the \emph{Back} button. & The main menu reappears. \\
    \bottomrule
  \end{tabularx}
...
\section{Define Protocol Menu}\label{sec:defprot}
  ...
  To define a protocol, the \emph{Step Size} spinner can be used to change the size of the step. The \emph{Number Of Steps} button can be used to change the number of iterations of the protocol. The \emph{Clear Protocol} button can be used to reset the protocol to the empty protocol.
  ...
  \begin{tabularx}{\textwidth}{XXX}
    ...
    \midrule
    View a graph of the current mixing run & Press the \emph{View Performance Graph} button. & The \emph{View Single Graph Panel} appears. \\
    \midrule
...
\section{Protocols Menu}\label{sec:protmenu}
  ...
  The \emph{Remove} button creates a pop-up panel containing the names of all saved protocols. Next to each of these names is a delete button that can be used to delete the protocol. Deleting a protocol cannot be undone.
  ...
  \subsection*{Formal description}
    ...
    \emph{Operation} & \emph{Steps} & \emph{Results} \\
    \midrule
    Save a protocol & Press the \emph{Save} button. & The \emph{Save Item Panel} appears. \\
    \midrule
    Load a protocol & Press the \emph{Load} button. & The \emph{Load Item Panel} appears. \\
    \midrule
    Remove a protocol & Press the \emph{Remove} button. & The \emph{Remove Item Panel} appears. \\
    \midrule
