...
Open your webbrowser and navigate to the \projectname{} website. Wait for the loading to finish and the menu to appear (figure \ref{fig:cellBrowser}).
...
If the menu gets in the way of the canvas, it is possible to hide the menu by pressing the menu toggle button (the button with the $\times$ on it) at the top right corner of the screen.
...
\screenshot{selectToolMenu}{The menu that appears after pressing the \emph{Select tool} button in the main menu.}
...
\subsection{Likely errors}
Only integer numbers are allowed for the drawing tool size. Furthermore the drawing tool size cannot get smaller than 1, nor bigger than 50. If the menu gets in the way of the canvas, it is possible to hide the menu by pressing the menu toggle button (the button with the $\times$ on it) in the top right corner of the screen.
...
\screenshot{defineProtMenu}{The menu that appears after pressing the \emph{Define protocol} button in the main menu. The values for \emph{step size}, \emph{number of steps} and the protocol are examples.}
...
\subsection{Likely errors}
If the menu gets in the way of the bars on the canvas, it is possible to hide the menu by pressing the menu toggle button (the button with the $\times$ on it) at the top right corner of the screen.
...
\screenshot{singleGraph}{The graph with the mixing performance of the last mixing run. The graph shown here is an example.}
...
\begin{enumerate}
	\item Press the \emph{Results} button in the main menu.
		\begin{itemize}
            The \emph{Mixing run results} menu appears (figure \ref{fig:mixResultMenu}).            
            \screenshot{mixResultMenu}{The menu that appears after pressing the \emph{Results} button in the main menu.}
		\end{itemize}
	...
	\item Select the mixing runs whose performance you want to compare, and press the \emph{Compare} button. \label{item:exportMultiGraphComp}
		...
		\end{itemize}
	\screenshot{multiGraph}{The graph with the mixing performance of the last mixing run. The graph shown here is an example.}
	\item Press the \emph{Export graph} button.
        \begin{itemize}
...
\begin{enumerate}
	\item Press the \emph{Distributions} button on the main menu.
		\begin{itemize}
            \item The \emph{Distributions} menu appears (figure \ref{fig:distMenu}).
	\screenshot{distMenu}{The menu that appears after pressing the \emph{Distributions} button in the main menu.}
		\end{itemize}
...
\begin{enumerate}
	...
	\item Press the \emph{Remove} button.
		\begin{itemize}
			\item A pop-up with the saved concentration distributions appears.
		\end{itemize}
	\item Press the \texttt{X}-button next to the distribution that you want to remove.
		\begin{itemize}
...
\begin{enumerate}
	...
	\item Press the \emph{Remove} button.
		\begin{itemize}
			\item A pop-up with the saved mixing protocols appears.
		\end{itemize}
	\item Press the \texttt{X}-button next to the protocol that you want to remove.
		\begin{itemize}
...
\begin{enumerate}
	...
	\item Press the \emph{Remove} button.
		\begin{itemize}
			\item A pop-up with the saved mixing runs appears.
		\end{itemize}
	\item Press the \texttt{X}-button next to the mixing run that you want to remove.
		\begin{itemize}
...
\begin{enumerate}
	...
	\item Press the \emph{Save} button.
		...
		\screenshot{saveItemPopup}{The pop-up that appears after pressing the \emph{Save} button in the \emph{Distributions} menu. This pop-up is also used for saving a mixing protocol (tutorial \ref{sec:savmixprot}) and a mixing run (tutorial \ref{sec:savmixrun}).}
		\end{itemize}
...
\screenshot{overwriteSavePopup}{The pop-up that appears after pressing the \emph{Save} button from the menu of figure \ref{fig:saveItemPopup}, when the entered name is already in use.}
