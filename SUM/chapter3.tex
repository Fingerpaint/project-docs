...
\section{Remove a concentration distribution from local storage}\label{sec:remdist}
...
%--------------NEW SECTION-----------------------------------------------
\section{Remove a mixing protocol from local storage}\label{sec:remmixprot}
...
%--------------NEW SECTION-----------------------------------------------
\section{Remove a mixing protocol from local storage}\label{sec:remmixrun}
...
\section{Save a concentration distribution}\label{sec:savdist}
...
\section{Save a mixing protocol}\label{sec:savmixprot}
...
\begin{enumerate}
	...
	\item Press the \emph{Save} button.
		\begin{itemize}
			\item The pop-up menu from figure \ref{fig:saveItemPopup} appears.
		\end{itemize}
	\item Enter a name for the mixing run in the text area, for instance \emph{protocol1}.
		\begin{itemize}
...
\subsection{Likely errors}
If the name entered in step 3 is already in use, the pop-up as shown in figure \ref{fig:overwriteSavePopup} is shown. Whenever you want to overwrite the existing mixing run, press the \emph{Overwrite} button.

%--------------NEW SECTION-----------------------------------------------

\section{Save a mixing run}\label{sec:savmixrun}
...
\section{View multiple performance results in one graph}\label{sec:viewmultgraph}
...
\begin{enumerate}
	...
	\item Select both \emph{mixingRun1} and \emph{mixingRun2} from the list.
		\begin{itemize}
...
If no items have been selected in step 3 when \emph{Compare} is pressed, a \emph{No data} message is shown.
