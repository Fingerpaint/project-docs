...
\subsubsection{Description}
You can define the initial distribution by dragging across the screen. On touch devices it's possible to draw straight lines by pressing with one finger on the start position of the line, and with another finger on the end position of the line.
