...
\begin{enumerate}
	\item Press the \emph{Results} button in the main menu.
		\begin{itemize}
            ...
            \screenshot{mixResultMenu}{The menu that appears after pressing \emph{Results} in the main menu.}
		\end{itemize}
...
\begin{enumerate}
	\item Press the \emph{Distributions} button on the main menu.
		\begin{itemize}
            ...
            \screenshot{distMenu}{The menu that appears after clicking \emph{Distributions} in the main menu.}
		\end{itemize}
