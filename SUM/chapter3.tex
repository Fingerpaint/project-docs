...
\subsubsection{Preparation}
If the session from tutorial \ref{sec:savdist} has been executed, navigate to the distributions menu by pressing the \emph{Distributions} button on the main menu.
...
\begin{enumerate}
	\item Press the \emph{Remove} button.
		...
		\screenshot{removeItemPopup}{The pop-up menu that appears after clicking the \emph{Remove} button in the distributions menu. This menu is also used for removing a mixing protocol (tutorial \ref{sec:remmixprot}) and a mixing run (tutorial \ref{sec:remmixrun}). The saved items shown here are examples.}
...
\begin{enumerate}
	\item Press the \emph{Save} button.
		...
		\screenshot{saveItemPopup}{The pop-up menu that appears after clicking the \emph{Save} button in the distributions menu. This menu is also used for saving a mixing protocol (tutorial \ref{sec:savmixprot}) and a mixing run (section \ref{sec:savmixrun}).}
		\end{itemize}
