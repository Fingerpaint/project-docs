...
\noindent The following assumptions are in place to achieve our desired average time goals (see Section \ref{sec_constrReq} -- Requirements regarding performance). % TODO: Make a proper reference
