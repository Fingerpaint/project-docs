...
\begin{figure}[h!]
\begin{center}
\includegraphics[keepaspectratio=true,width=800 pt,height=508 pt]{UseCaseDiagram.pdf}\captionof{figure}{Use Case Diagram including all the use cases described in Appendix B.\label{ucd}}
\end{center}
\end{figure}
