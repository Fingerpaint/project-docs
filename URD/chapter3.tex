...
CPR13 & could have \\
\multicolumn{2}{p{\textwidth}}{The user can define a mixing protocol for a circle geometry as a sequence of rotation of circle.}\\
\hline
...
CPR22 & should have \\
\multicolumn{2}{p{\textwidth}}{The user can save the image from CPR09 locally to their device in a vector format (e.g. SVG format).} \\
\hline
...
CPR25 & could have \\
\multicolumn{2}{p{\textwidth}}{Users can save the animation from CPR12 locally to their device, using a animated vector format (e.g. EVA format).} \\
\hline
...
CPR29 & should have \\
\multicolumn{2}{p{\textwidth}}{Users can retrieve the mixng performance results that are stored locally on their device.} \\
\hline
