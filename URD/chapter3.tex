...
This chapter explicitly states all requirements and constraints of the application to be developed. The requirements are based upon the use cases as described in Appendix B. The final product will be delivered conform these requirements. Any requirements following from further requests can only be added after consultance with, and being granted permission by, the technical advisor and senior management.\\
