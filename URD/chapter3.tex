...
\stepcounter{count}
CPR\arabic{count} & must have \\
\multicolumn{2}{p{\textwidth}}{The user can draw with a circle-shaped drawing tool.} \\
\hline
\stepcounter{count}
CPR\arabic{count} & must have \\
...
\stepcounter{count}
CPR\arabic{count} & should have \\
\multicolumn{2}{p{\textwidth}}{The user can draw with a square-shaped drawing tool.} \\
\hline
\stepcounter{count}
CPR\arabic{count} & should have \\
\multicolumn{2}{p{\textwidth}}{The user can adjust the size of the drawing tool.} \\
\hline
\stepcounter{count}
CPR\arabic{count} & should have \\
\multicolumn{2}{p{\textwidth}}{The user can save an initial concentration distribution locally on their device.} \\
\hline
\stepcounter{count}
CPR\arabic{count} & should have \\
\multicolumn{2}{p{\textwidth}}{The user can remove a previously saved initial concentration distribution.} \\
\hline
\stepcounter{count}
CPR\arabic{count} & should have \\
...
\stepcounter{count}
CPR\arabic{count} & should have \\
\multicolumn{2}{p{\textwidth}}{The user can save a mixing protocol locally on their device.} \\
\hline
\stepcounter{count}
CPR\arabic{count} & should have \\
\multicolumn{2}{p{\textwidth}}{The user can remove a previously saved mixing protocol.} \\
\hline
\stepcounter{count}
CPR\arabic{count} & should have \\
...
\stepcounter{count}
CPR\arabic{count} & could have \\
\multicolumn{2}{p{\textwidth}}{The user can define a mixing protocol for a \emph{Journal Bearing} geometry as a sequence of rotations of inner and outer circles.}\\
\hline
\stepcounter{count}
CPR\arabic{count} & could have \\
