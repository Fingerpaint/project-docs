...
CPR06 & could have \\
\multicolumn{2}{p{\textwidth}}{The user can select a predifined initial concentration distribution from a list.} \\
\hline
...
CPR17 & could have \\
\multicolumn{2}{p{\textwidth}}{The user can select a predifined mixing protocol for the specified geometry from a list.}\\
\hline
