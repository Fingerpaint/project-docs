...
\subsubsection*{Purpose}
Provides functionality for the following software requirements:\\
SRQ99, SRQ100, SRQ101, SRQ106, SRQ107, SRQ108, SRQ109, SRQ110
...
\subsubsection*{Subordinates}
\todo{The Simulator Service is composed of multiple java classes}

\subsubsection*{Dependencies}
The Simulation Service depends on the Fortran Module for technical calculations.

\subsubsection*{Interfaces}
The Simulation Service uses the Fortran Module's interface for communications to it. This communication is done in C and Fortran. The Simulator Service itself is accessible through the Simulator Service Communication. JNI is used for the Simulator Service Communication.
...
\todo{make activity diagram for the simulator service}
...
This component it is only accessed through the Application Service component. The Application Persistence Communication is used for this purpose. The Application Persistence Commucation exists of Java calls.
...
Follows from the component’s function and interfaces.
...
\subsubsection*{Interfaces}
%Data and control flow in and out
This component is accessed through the application service component, the application state component and the update application persistence component. The application service communication is used for the communication with the application service components. This communication consists of a Java call. For communication with the two components on the client-side of the application, HTTP is used.
...
\subsubsection*{Interfaces}
\begin{description}
\item The Application Service has an interface with the Application Persistence component. This communication is done through a Java call.
\item The Application Service has an interface with the Simulator Service component.This communication is done throught JNI.
\item The Application Service has an interface with the HTTP Server component. This communication is done through a Java call.
\end{description}
...
\subsubsection*{Processing}
\todo{Make activity diagram}

\subsubsection*{Data}
\todo{Internal data - ask Thom/Lasse}\\
...
\subsubsection*{Purpose}
Provides functionality for the following software requirements:\\
SRQ46, SRQ47, SRQ48, SRQ49, SRQ50, SRQ51, SRQ52, SRQ53, SRQ54, SRQ55, SRQ56, SRQ57, SRQ58, SRQ59, SRQ60, SRQ61, SRQ62, SRQ63, SRQ64, SRQ65, SRQ66, SRQ67, SRQ68, SRQ69, SRQ70, SRQ71, SRQ72, SRQ73, SRQ74, SRQ75, SRQ76, SRQ77, SRQ78, SRQ79, SRQ84, SRQ85, SRQ86, SRQ87, SRQ88, SRQ89, SRQ90, SRQ91, SRQ92, SRQ93, SRQ94, SRQ95, SRQ96, SRQ97
