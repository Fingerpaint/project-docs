...
\subsubsection*{Processing}
No internal processing of data takes place in the Application Service. It only passes data to the next component. \todo{Ask Lasse/Thom whether this is true... Maybe the data is parsed from/to some other format, in which it can pass the HTTP Server?}.

\subsubsection*{Data}
The Application Service doesn't contain any internal data. The only data residing in this component is the data passing through with requests. \todo{Is this true? Ask Thom/Lasse}
